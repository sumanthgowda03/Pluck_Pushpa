...
export function Header() {
  return (
    <header className="bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 shadow-lg border-b-4 border-yellow-400 sticky top-0 z-50">
          ...
          <div className="flex items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <span className="text-sm text-yellow-200 font-medium">✨ Fresh & Beautiful ✨</span>
              </div>
            </div>
          </div>
          
          <nav className="hidden md:flex space-x-8">
            <a href="#products" className="text-white hover:text-yellow-300 transition-colors font-semibold text-lg hover:scale-105 transform duration-200">
              🌺 Products
            </a>
